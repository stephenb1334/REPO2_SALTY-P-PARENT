        ...
        <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-[1fr_20rem] lg:gap-x-16 xxl:gap-x-48">
          <div className="max-w-lg">
            <div className="prose md:prose-md lg:prose-lg">
              <h2 id="heading-2">Important Guidelines</h2>
              <p>
                <strong>
              ...
              <h3 id="heading-3">Implementation Steps</h3>
              <p>
              ...
              <h4 id="heading-4">Animation Settings</h4>
              <p>
              ...
              <h5 id="heading-5">Trigger Configuration</h5>
              <p>
                Morbi sed imperdiet in ipsum, adipiscing elit dui lectus. Tellus
                id scelerisque est ultricies ultricies. Duis est sit sed leo
                nisl, blandit elit sagittis. Quisque tristique consequat quam
              ...
              <h6 id="heading-5">Troubleshooting Tips</h6>
              <p>
